        ...
        <div class="row">
          <div class="col-lg-6 col-lx-4">
            <div class="order-info">
              <h4 class="text-center pb-4">INFORMATION COMMANDE</h4>
              <table class="table">
                    <tr class="">
                        <td>Numero</td>
                        <td> : {{$order->order_number}}</td>
                    ...
                    <tr>
                        <td>Charge Expedition</td>
                        <td> : {{$order->shipping->price}}F</td>
                    </tr>
                    <tr>
                      <td>Coupon</td>
                      <td> : {{number_format($order->coupon)}}F</td>
                    </tr>
                    <tr>
                        <td>Montant Total</td>
                        <td> : {{number_format($order->total_amount)}}F</td>
          ...
          <div class="col-lg-6 col-lx-4">
            <div class="shipping-info">
              <h4 class="text-center pb-4">INFORMATION EXPEDITION </h4>
              <table class="table">
                    <tr class="">
                        <td>Full Name</td>
                        <td> : {{$order->first_name}} {{$order->last_name}}</td>
