<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin')}}">
      ...
      <div class="sidebar-brand-text mx-3">L-SHOPE</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('brand.create')}}">Add Marques</a>
          </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Expedition Options:</h6>
            <a class="collapse-item" href="{{route('shipping.index')}}">Expedition</a>
            <a class="collapse-item" href="{{route('shipping.create')}}">Add Expedition</a>
          </div>
        </div>
    </li>
