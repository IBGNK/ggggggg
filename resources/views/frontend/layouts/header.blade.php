        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        @php
                            $logo = DB::table('settings')->value('logo'); // Récupère directement la valeur du logo
                        @endphp
                        <a href="{{ route('home') }}">
                            <img src="{{ $logo }}" alt="logo" style="max-width: 160px; max-height: 60px; object-fit: contain;">
                        </a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="@if(Request::path()=='product-grids'||Request::path()=='product-lists')  active  @endif"><a href="{{route('product-grids')}}">Produits</a></li>
                                                {{Helper::getHeaderCategory()}}
                                            <li class="{{Request::path()=='blog' ? 'active' : ''}}"><a href="{{route('blog')}}">Article</a></li>
